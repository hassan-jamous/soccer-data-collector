...
public class HashMapSeasonIDVersion3 {

	public HashMap<SeasonIDObject, String> seasonsID ;

	public HashMapSeasonIDVersion3() {
		...
		seasonsID.put(new SeasonIDObject("Primera Division", "2015/2016"),"10495");
		seasonsID.put(new SeasonIDObject("Primera Division", "2014/2015"),"8578");
		seasonsID.put(new SeasonIDObject("Primera Division", "2013/2014"),"6559");
		seasonsID.put(new SeasonIDObject("Primera Division", "2012/2013"),"4959");
		seasonsID.put(new SeasonIDObject("Primera Division", "2011/2012"),"3502");
		seasonsID.put(new SeasonIDObject("Liga BBVA", "2010/2011"),"2896");
		seasonsID.put(new SeasonIDObject("Liga BBVA", "2009/2010"),"2252");
		seasonsID.put(new SeasonIDObject("Liga BBVA", "2008/2009"),"1587");
		seasonsID.put(new SeasonIDObject("Primera Division", "2007/2008"),"669");
		seasonsID.put(new SeasonIDObject("Primera Division", "2006/2007"),"102");
		seasonsID.put(new SeasonIDObject("Primera Division", "2005/2006"),"101");
		seasonsID.put(new SeasonIDObject("Primera Division", "2004/2005"),"100");
		seasonsID.put(new SeasonIDObject("Primera Division", "2003/2004"),"99");
		seasonsID.put(new SeasonIDObject("Primera Division", "2002/2003"),"70");
		seasonsID.put(new SeasonIDObject("Primera Division", "2001/2002"),"71");
		seasonsID.put(new SeasonIDObject("Primera Division", "2000/2001"),"72");
		seasonsID.put(new SeasonIDObject("Primera Division", "1999/2000"),"73");
		seasonsID.put(new SeasonIDObject("Primera Division", "1998/1999"),"74");
		seasonsID.put(new SeasonIDObject("Primera Division", "1997/1998"),"75");
		seasonsID.put(new SeasonIDObject("Primera Division", "1996/1997"),"25689");
		seasonsID.put(new SeasonIDObject("Primera Division", "1995/1996"),"25690");
		seasonsID.put(new SeasonIDObject("Primera Division", "1994/1995"),"25688");
		seasonsID.put(new SeasonIDObject("Primera Division", "1993/1994"),"25687");
		...
		seasonsID.put(new SeasonIDObject("Division 1", "2001/2002"),"61");
		seasonsID.put(new SeasonIDObject("Division 1", "2000/2001"),"62");
		seasonsID.put(new SeasonIDObject("Division 1", "1999/2000"),"63");
		seasonsID.put(new SeasonIDObject("Division 1", "1998/1999"),"64");
		seasonsID.put(new SeasonIDObject("Division 1", "1997/1998"),"65");

	}
	
	public String get(SeasonIDObject key) {
		
			if(! this.seasonsID.containsKey(key)) {
				throw new RuntimeException("there is no comppetition with this inforamtion "+key.competitionName +" at "+key.years);
			}
			return this.seasonsID.get(key);
		}
