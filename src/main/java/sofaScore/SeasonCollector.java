...
public class SeasonCollector {
	...
	public PageOfSeasonRounds getSeasonRounds(String competitionName , String competitionYears) {
		...
		if(gsonString.contains("Not Found")) {return getSeasonRoundsIfNotFoundInSite(competitionName,competitionYears);}
		Gson gson = new Gson();
	...
	public void writeSeason(String competitionName, String competitionYears) {
		...
		if((seasonRounds.currentRound.name == null) || (seasonRounds.currentRound.name=="Not Found")) {
			...
			for(int i=0; i <seasonRounds.rounds.size(); i++) {
				roundCollerctor.writeRound(competitionName, competitionYears , String.valueOf( seasonRounds.rounds.get(i).round),(seasonRounds.rounds.get(i).slug==null)?"":"/slug/"+seasonRounds.rounds.get(i).slug);
			}
		}
	}
	 ...
	 * 
	 * @param competitionName for example ( Premier League , LaLiga  , Bundesliga , Seria A .....)
	 * @param startYear for example ( 2009/2010 , 2013/2014 , 2007/2008 , 2015/2016 , ......)
	 */
	 ...
	 * 
	 * @param competitionName for example ( Premier League , LaLiga  , Bundesliga , Seria A .....)
	 * @param startYears for example ( 2009/2010 , 2013/2014 , 2007/2008 , 2015/2016 , ......)
	 * @param endYears
	 */
	...
	/**
	 * 
	 * these seasons do not contain any information about rounds , just the last ranking table and 
	 * the last round's games(just result) like this game
	...
	private PageOfSeasonRounds getSeasonRoundsIfNotFoundInSite(String competitionName , String competitionYears) {
		...
		if(competitionName.equals("LaLiga") &&  competitionYears.equals("1998/1999") ) {result.currentRound.round = 38;	return result;}
		...
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1993/1994") ) {result.currentRound.round = 42;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1994/1995") ) {result.currentRound.round = 42;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1995/1996") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1996/1997") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1997/1998") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1998/1999") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("1999/2000") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("2000/2001") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("2001/2002") ) {result.currentRound.round = 38;	return result;}
		if(competitionName.equals("Premier League") &&  competitionYears.equals("2002/2003") ) {result.currentRound.round = 38;	return result;}
