...
import worldfootball.testData.WorldFootballWorldFootballTopScoreAndTopScoreForCompetitionAllYearsValue;
...
public class TopScoreCollectorTest {
	...
	WorldFootballWorldFootballTopScoreAndTopScoreForCompetitionAllYearsValue 	 topScoreWorldFootballValue = new WorldFootballWorldFootballTopScoreAndTopScoreForCompetitionAllYearsValue();
	    ...
	    public void itShouldGetTopSoccerForCompetitionAtOneSeason() {
	        ...
	        ArrayList<PlayerTopSoccerAtSeason> table2019_2020player0TO4ExpectedValue = topScoreWorldFootballValue.getTableTopScoreEnglishPriemerLeague2019_2020();
	        ...
	        ArrayList<PlayerTopSoccerAtSeason> table2009_2010player4TO9ExpectedValue = topScoreWorldFootballValue.getTopScoreEnglishPreimerLeague2009_2010();
	        ...
	        ArrayList<PlayerTopSoccerAtSeason> table1946_1947player0TO4ExpectedValue = topScoreWorldFootballValue.getTopScoreEngishPriemerLeague1946_1947();
