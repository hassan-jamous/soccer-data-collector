...
import worldfootball.testData.WorldFootballClubsInSeasonValues;
import worldfootball.testData.WorldFootballPlayerSummuryInClub_Squad_Values;
...
public class ClubsCollectorTest {
	...
	WorldFootballClubsInSeasonValues clubsValues = new WorldFootballClubsInSeasonValues();
    WorldFootballPlayerSummuryInClub_Squad_Values playersInClubs_Squad_Values = new WorldFootballPlayerSummuryInClub_Squad_Values();
    ...
    public void itShouldGetPlayersSummuryInClub() {
        ...
        ArrayList<PlayerSummary> playersManchesterUnited2015ActualValue = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("manchester-united", "2015");
        ...
        ArrayList<PlayerSummary> playersManchesterUnited2001ActualValue = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("manchester-united", "2001");
        ...
        ArrayList<PlayerSummary> playersManchesterUnited1991ActualValue = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("manchester-united", "1991");
        ...
        ArrayList<PlayerSummary> playersManchesterUnited1970ActualValue = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("manchester-united", "1970");
        ...
        ArrayList<PlayerSummary> manchesterUnitedActualValueplayers1966 = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("manchester-united", "1966");
        ...
        ArrayList<PlayerSummary> playersManchesterUnited1890ActualValue = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("manchester-united", "1890");
        ...
        ArrayList<PlayerSummary> playersAccrington1890ActualValue = screenScraperUnderTest.clubsCollector.get_ClubSquad_AllPlayersSummaryInClub("Accrington", "1890");
