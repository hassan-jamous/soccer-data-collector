...
public class GameIencidentsValues {
	...
	public List<Iencident> getGameEnglishPreimerLeague20_21Crystal_Palace_Sheffield_United_IecidentsExpexted() {
        ...
        gameIencidentsExpectedValueValue.add(new IencidentInGameChangePlayers(
        		new IencidentInGamePlayer ("Jaïro Riedewald",null,null,"jairo-riedewald","J. Riedewald","M","340","285989"),
        ...
        gameIencidentsExpectedValueValue.add(new InncidentInGameCard( 
        		new IencidentInGamePlayer ("Eberechi Eze",null, null, "eberechi-eze","E. Eze","M","2130","864921"),
        ...
        gameIencidentsExpectedValueValue.add(new IencidentInGameChangePlayers(
        		new IencidentInGamePlayer ("Rhian Brewster","","","rhian-brewster","R. Brewster","F","2764","878705"),
        		new IencidentInGamePlayer ("Lys Mousset","","","lys-mousset","L. Mousset","F","716","377108"),
        		null,"120002050", "61", null, "false", null, "substitution"  ));
                     
        gameIencidentsExpectedValueValue.add(new IencidentInGameChangePlayers(
        		new IencidentInGamePlayer ("Jordan Ayew",null,null,"jordan-ayew","J. Ayew","F","7144","103045"),
        		new IencidentInGamePlayer ("Christian Benteke","","","christian-benteke","C. Benteke","F","1798","45970"),
		...
		gameIencidentsExpectedValueValue.add(
				new InncidentInGameCard(
						new IencidentInGamePlayer ("Jayden Bogle",null,null,"bogle-jayden","J. Bogle","D","297","929132"),
	     ...
	     gameIencidentsExpectedValueValue.add(new IencidentInGameChangePlayers(
	        		new IencidentInGamePlayer ("Eberechi Eze",null,null,"eberechi-eze","E. Eze","M","2130","864921"),
	        		new IencidentInGamePlayer ("Jeffrey Schlupp",null,null,"jeffrey-schlupp","J. Schlupp","M","556","148710"),
	...
	public List<Iencident> getGameEnglishPreimerLeague20_21Burnley_Manchester_United_IecidentsExpexted() {
		...
		gameIencidentsExpectedValueValue.add(new IencidentInGameChangePlayers(
        		new IencidentInGamePlayer ("Axel Tuanzebe","","","axel-tuanzebe","A. Tuanzebe","D","2189","817979"),
        		new IencidentInGamePlayer ("Anthony Martial","","","anthony-martial","A. Martial","F","28341","191176"),
        		null,"120012870","90","5","false",null,"substitution"));
		
        gameIencidentsExpectedValueValue.add(new IencidentInGameInjuryTime("4","90","0","injuryTime"));

        gameIencidentsExpectedValueValue.add(new IencidentInGameChangePlayers(
        		new IencidentInGamePlayer ("Scott McTominay","","","scott-mctominay","S. McTominay","M","5537","879346"),
        		new IencidentInGamePlayer ("Bruno Fernandes","","","bruno-fernandes","B. Fernandes","M","50682","288205"),
