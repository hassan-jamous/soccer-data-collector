...
public class WorldFootballClubsValues {

	public List<Club> clubsAt1889_1890Expected() {
	...
	public List<Club> clubsAt1967_1968Expected() {
		return Arrays.asList(
        		new Club("Arsenal FC"),
        		new Club("Burnley FC"),
        		new Club("Chelsea FC"),
	...
	public List<Club> clubsAt2015_2016Expected() {
		return Arrays.asList(
