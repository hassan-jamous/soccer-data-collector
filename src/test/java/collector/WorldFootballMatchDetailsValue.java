...
public class WorldFootballMatchDetailsValue {
	...
	MatchDetails getGame2019_2020BrightonHoveAlbionEvertonFc() {
	...
	MatchDetails getGame1946_1947BrentfordFcMiddlesbroughFc() {
	...
	MatchDetails getGame2020_2021LeedsUnitdBurnleyFc() {
	...
	MatchDetails getGame2020_2021SheffieldUnitdEvertonFc() {
